          ...
          <div>
            <ul class="mt-6 leading-10">
              <li class="relative px-2 py-1 ">
                <a href="/admin" class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-green-500" href=" #">
                    ...
                    <li class="px-2 py-1 text-white transition-colors duration-150">
                      <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                        <div class="flex items-center">
                          ...
                          <a href="/admin/product" class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800">product</a>
                        </div>
                      </div>
                    </li>
                    <li class="px-2 py-1 text-white transition-colors duration-150">
                      <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                        <div class="flex items-center">
                          ...
                          <a href="/admin/category" class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800">category</a>
                        </div>
                      </div>
                    </li>
                    <li class="px-2 py-1 text-white transition-colors duration-150">
                      <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                        <div class="flex items-center">
                          ...
                          <a href="/admin/user" class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800">user</a>
                        </div>
                      </div>
                    </li>
                  </ul>
      ...
      <div>
        <div class="text-white">
          <div class="flex p-2  bg-gray-800">
            <div class="flex py-3 px-2 items-center">
              <p class="text-2xl text-green-500 font-semibold">SA</p>
              <a href="/admin" class="ml-2 font-semibold italic">
                DASHBOARD</a>
            </div>
          </div>
          <div>
